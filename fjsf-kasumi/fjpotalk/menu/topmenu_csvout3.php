...
// 2018-12-12 シフトの表示を追加
// 2019-01-25 時間帯：22時から表示開始対応とシフト小計追加対応
//**********************************************************************
	...
	//データ出力
	$sql = "SELECT * FROM " . $Const_DB_SCHEMA . "wdeskhistory3timefj"; //2019-01-22 時間の表示順を変更
	$sql = $sql . " WHERE (userid='" . $$Const_COMPANYCODE . $user . "')";
	$sql = $sql . " ORDER BY SubTotalFlg, RecFlg, DspNo";
